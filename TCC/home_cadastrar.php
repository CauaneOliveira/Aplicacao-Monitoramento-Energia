...
<!--LADO_ESQUERDO----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class="title">
        <h1>Adicionar aparelhos</h1>
    </div>
    
    <form action="cadastrar_aparelhos.php" method="POST">
        <label id="nome_ap" for="nome_ap"><b>Nome do aparelho</b></label><br>
        <input type="text" id="nome_ap" name="nome_ap" required><br>
        
        <label id="qtd" for="qtd"><b>Quantidade</b></label><br>
        <input type="number" id="qtd" name="qtd" min="1" required><br>
        ...
        <input type="number" id="pot" name="pot" min="1" required><br>
...
<div class="all">
    ...
    <a href="#" onclick="ap01();"><div class="elipse_v" id="v1"><img src="https://cdn-icons-png.flaticon.com/512/5650/5650519.png"></a><p>TELEVISÃO</p></div>
    <a href="#" onclick="ap02();"><div class="elipse_a" id="a1"><img src="https://cdn-icons-png.flaticon.com/512/5650/5650689.png"></a><p>AR CONDICIONADO</p></div>
    <a href="#" onclick="ap03()"><div class="elipse_v" id="v2"><img src="https://cdn-icons-png.flaticon.com/512/5650/5650773.png"></a><p>LIQUIDIFICADOR</p></div></a>
    <a href="#" onclick="ap04()"><div class="elipse_a" id="a2"><img src="https://cdn-icons-png.flaticon.com/512/5650/5650859.png"></a><p>VENTILADOR</p></div></a>
</div>
